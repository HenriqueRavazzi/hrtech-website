...
const DesenvolvimentoSoftwareForm = () => {
  return (
    <>
      <div className="mb-6">
        <label htmlFor="tipoProjeto" className="block text-lg font-medium mb-2">Tipo de projeto</label>
        <select id="tipoProjeto" className="w-full p-3 bg-gray-700 border border-gray-600 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
      ...
      <div className="mb-6">
        ...
        <select id="duracaoEstimada" className="w-full p-3 bg-gray-700 border border-gray-600 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
      ...
      <div className="mb-6">
        ...
        <select id="estagioAtual" className="w-full p-3 bg-gray-700 border border-gray-600 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
      ...
      <div className="mb-6">
        ...
        <textarea id="descricaoProjeto" rows={4} className="w-full p-3 bg-gray-700 border border-gray-600 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"></textarea>
      </div>
    </>
  );
};
